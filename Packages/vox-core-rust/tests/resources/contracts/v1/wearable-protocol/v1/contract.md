...
The 17 exact kinds cover capability/version negotiation; inventory and complete hashed frozen preset snapshot; transcript/Recording Only metadata; asset manifest and resumable frontier; reconciliation and transport receipt; correlated phone-ingested/vault-committed/failure/discard/deletion outcomes; and reassignment/retry/discard actions. Recording Only requires disabled ASR, excluded location, and both native folder/filename policy references.
